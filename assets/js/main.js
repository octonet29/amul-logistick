	...
	$(document).ready(function () {
		...
		$(".lang-dropdown li").each(function () {
			...
			thisItem.on("click", function () {
				...
				const selectedTextContainer = thisItem
					.closest(".group-item")
					.find(".selected-text")
		...
		$(".transport-way-item").on("mouseenter", function () {
			$(".transport-way-item")
				.find(".transport-way-item__icon")
				.removeClass("bg-main-two-600")
			$(".transport-way-item")
				.find(".transport-way-item__content")
				.removeClass("border-main-two-600")
				.addClass("border-neutral-50 ")

			$(this).find(".transport-way-item__icon").addClass("bg-main-two-600")
			$(this)
				.find(".transport-way-item__content")
				.removeClass("border-neutral-50")
				.addClass("border-main-two-600")
		})
		...
		var testimonialsThreeThumbsSlider = new Swiper(
			".testimonials-three-thumbs-slider",
			{
				slidesPerView: 1,
				loop: true,
				freeMode: true,
		...
		var testimonialsThreeContentSlider = new Swiper(
			".testimonials-three-content-slider",
			{
				slidesPerView: 1,
				loop: true,
				effect: "creative",
